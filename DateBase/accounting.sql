...
INSERT INTO Banks VALUES(1, 20100, 50000, STR_TO_DATE('2023-01-01','%Y-%m-%d'), 'bonus money', 40000, 50000)
INSERT INTO Banks VALUES(2, 10602, 1000, STR_TO_DATE('2023-01-02','%Y-%m-%d'), 'rent', 10000, null);